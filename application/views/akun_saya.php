  ...
  <!-- Responsivity for older IE -->
    ...
    <body>
      <div id="all">
            ...
            <div class="row">
              ...
              <div class="col-md-5">
                <ul class="breadcrumb">
                  ...
                  <li>My Account</a></li>
                  <li><?php echo $_SESSION['user']['nama_user'] ?></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div id="content">
          <div class="container">
            <div class="row mb-small" id="productMain">
              <div class="col-sm-2 col-xs-6">
                <h3><i class="fa fa-user"></i> Nama</h3><hr>
                <h3><i class="fa fa-envelope"></i> Email</h3><hr>
                <h3><i class="fa fa-user"></i> Username</h3><hr>
                <h3><i class="fa fa-phone"></i> No.Telepon</h3><hr>
              </div>
              <div class="col-sm-4 col-xs-6">
                <h3><?php echo $_SESSION['user']['nama_user'] ?></h3><hr>
                <h3><?php echo $_SESSION['user']['email'] ?></h3><hr>
                <h3><?php echo $_SESSION['user']['username'] ?></h3><hr>
                <h3><?php echo $_SESSION['user']['whatsapp_user'] ?></h3><hr>
              </div>
              <div class="col-sm-2 col-xs-6 col-sm-offset-2 col-xs-offset-3 ">
                <div >
                  <img src="<?php echo base_url('assets/img/').$_SESSION['user']['foto_user'] ?>" width="100%" height="100%" class="img-responsive">
        ...
        <!-- <p class="text-center">
          <a href="<?php echo base_url(); ?>akun/edit/<?php echo $_SESSION['user']['id_user'] ?>" class="btn btn-template-main"><i class="fa fa-edit"></i> Edit Profil</a>
        </p> -->
