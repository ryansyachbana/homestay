    ...
    <body>
      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row">
            <div class="col-md-7">
              <h1><?php echo $detail_homestay['nama_homestay'] ?></h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb">
                <li><a href="<?php echo base_url('tuser') ?>">Home</a></li>
                <li><a href="<?php echo base_url('bhome') ?>">Backpacker Homestay</a></li>
                <li><?php echo $detail_homestay['nama_homestay'] ?></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              ...
              <p class="goToDescription"><a href="#details" class="scroll-to text-uppercase">Scroll to detail homestay</a>
              </p>
              <div class="row" id="productMain">
                <div class="col-sm-6">
                  <div id="mainImage" style="margin-top: 30px;">
                    <img src="<?php echo base_url('assets/img/').$detail_homestay['foto_homestay'] ?>" width="100%" class="img-rounded">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="box">
                    <form method="post">
                      <div class="sizes">
                        <h3><?php echo $detail_homestay['nama_homestay'] ?></h3>
                        <h3><i class="fa fa-home"></i> <?php echo $detail_homestay['jumlah_kamar'] ?></h3>
                        <h3><i class="fa fa-map-marker"></i> <?php echo $detail_homestay['alamat_homestay'] ?></h3>
                      </div>
                      <p class="price">Rp <?php echo $detail_homestay['harga_homestay'] ?></p>
                      <p class="text-center">
                        <!-- <a href="<?php echo base_url('send_email') ?>/detail/<?php echo $detail_homestay['id_homestay'] ?>" class="btn btn-template-main"><i class="fa fa-shopping-cart"></i> Booking Now</a> -->
                        <a href="https://api.whatsapp.com/send?phone=628974185186&amp;text=Halo%20,%20Saya%20mau%20booking....." class="btn btn-template-main"><i class="fa fa-shopping-cart"></i> Booking Now</a>
      ...
      <div class="container">
        <div class="box" id="details">
          ...
          <p><?php echo $detail_homestay['deskripsi_homestay'] ?></p>
        </div>  
      </div>
      <br>
...
<div id="map"></div>
  ...
  <script>
    ...
    // right-to-left.
    function initMap() {
        var cairo = {lat: <?php echo $detail_homestay['latitude'] ?>, lng: <?php echo $detail_homestay['longitude'] ?>};
